---
name: git-workflow
description: INdigo 프로젝트의 Git 작업 전체 규칙 — 브랜치 전략·네이밍, 커밋 메시지 컨벤션, PR 작성 규칙. 브랜치를 만들거나, 커밋·푸시하거나, PR을 열기 직전에 반드시 이 스킬을 로드하세요. "커밋해줘", "브랜치 따줘", "PR 올려줘", "푸시해줘" 같은 요청이나 작업을 마무리해 변경사항을 반영하려 할 때 항상 사용합니다. 이 스킬이 INdigo Git 규칙의 단일 출처입니다.
---
