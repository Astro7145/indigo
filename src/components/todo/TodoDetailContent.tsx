  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <IconButton aria-label={tc('actions.close')} onClick={onClose} className="shrink-0">
        ...
        {todo.goal && (
          <div className="flex w-full items-center gap-2">
            <div className="flex shrink-0 items-center gap-1">
              ...
              <span className={metaLabelClass}>{t('fields.goal')}</span>
            </div>
        ...
        {dueDate && (
          <div className="flex w-full items-center gap-2">
            <div className="flex shrink-0 items-center gap-1">
              ...
              <span className={metaLabelClass}>{t('fields.dueDate')}</span>
            </div>
        ...
        {todo.tags.length > 0 && (
          <div className="flex w-full items-start gap-2">
            <div className="flex shrink-0 items-center gap-1 text-slate-400">
              ...
              <span className="text-sm font-medium whitespace-nowrap">{t('fields.tag')}</span>
            </div>
      ...
      {hasAttachment && (
        <section className="flex w-full flex-col gap-2">
          <h3 className={sectionTitleClass}>{t('detail.attachment')}</h3>
          <div className="flex flex-col gap-3">
            ...
            {todo.fileUrl && (
              <div className="relative aspect-[408/223] w-full overflow-hidden rounded-[4px] border border-slate-200">
                <Image src={todo.fileUrl} alt={tc('image.attachmentAlt')} fill className="object-cover" />
              </div>
            )}
          </div>
        </section>
      ...
      {notes.length > 0 && (
        <section className="flex w-full flex-col gap-2">
          <h3 className={sectionTitleClass}>{t('detail.notes')}</h3>
