 ...
 *
 * Figma 21209:54557 (308×160). 그라데이션 + 스프링노트 일러스트(IcSpringNote로 근사) + 안내 텍스트.
...
export default function GoalNotesCard({ goalId, className }: GoalNotesCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      {/* 스프링노트 일러스트 — 우측에 기울여 배치, 그라데이션에 자연스럽게 녹도록 luminosity 블렌드 */}
      <IcSpringNote
        aria-hidden
        size="lg"
        className="pointer-events-none absolute -top-3 -right-3 size-[150px] rotate-12 opacity-90 mix-blend-luminosity"
      />
      {/* 안내 텍스트 + 우측 chevron */}
