...
const renderSection = (overrides?: Partial<ComponentProps<typeof GoalTodoSection>>) =>
  renderWithIntl(<GoalTodoSection onEditTodo={() => {}} onAddTodo={() => {}} onSelectTodo={() => {}} {...overrides} />);
...
it('다음 페이지 로딩 중이면 로딩 표시를 렌더한다', async () => {
