      ...
      {todoId != null && (
        <div key="note-drawer" className="fixed inset-0 z-60">
          ...
          <motion.div
            ...
            className="absolute inset-y-0 right-0 flex w-full scrollbar-gutter-stable flex-col overflow-y-auto bg-slate-100 px-4 py-6 shadow-2xl sm:px-6 sm:py-12 xl:w-[40%] xl:min-w-[650px] xl:px-10"
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
