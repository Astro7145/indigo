...
export function NoteLinkPreviewFallback() {
  return (
    <div
      role="status"
      className="dark:bg-indigo-dark-400 flex items-start gap-3 rounded-lg bg-slate-50 px-3 py-2 sm:px-4 sm:py-3"
    >
      <div className="size-5 shrink-0 animate-pulse rounded-sm bg-slate-200 sm:size-6 dark:bg-white/10" />
      <div className="flex min-w-0 flex-1 flex-col gap-1.5 py-0.5">
        <div className="h-3 w-2/3 animate-pulse rounded bg-slate-200 sm:h-3.5 dark:bg-white/10" />
