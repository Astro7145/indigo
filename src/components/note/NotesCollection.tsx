...
export default function NotesCollection({ goalId, className }: NotesCollectionProps) {
  ...
  return (
    <div className={cn('mx-auto flex w-full max-w-[1312px] flex-col gap-6', className)}>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-slate-800">노트 모아보기</h1>
        <div className="flex items-center gap-3">
          ...
          <Dropdown>
            <Dropdown.Trigger asChild>
              <button type="button" className="flex shrink-0 items-center gap-1 text-sm text-slate-600">
                {SORT_LABELS[sort]}
      ...
      <div className="flex items-center gap-3 rounded bg-indigo-100 px-6 py-5">
