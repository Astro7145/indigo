...
interface BottomSheetProps {
  ...
  closeOnBackdropClick?: boolean; // 작성 중 내용 보호 등으로 백드롭 클릭 닫기를 막을 때 false
}
...
export default function BottomSheet({
  ...
  // propagate: 상위 AnimatePresence(ModalStack)가 이 시트를 스택에서 제거할 때 그 exit를
  // 내부로 전파받아 slide-down을 재생한다.
  return (
