...
export function IcTask({ small, className, ...rest }: IcTaskProps) {
  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn(small ? 'size-8' : 'size-10', className)} {...rest}>
      <rect width="40" height="40" rx="4" fill="var(--color-indigo-400)" className="dark:fill-indigo-dark-500" />
      <svg x="10" y="6.25" width="20" height="26" viewBox="0 0 16 21">
        ...
        <rect
          ...
          className="dark:fill-indigo-dark-700"
        />
        <circle cx="8.0001" cy="2.4" r="2.4" fill="var(--color-indigo-700)" className="dark:fill-indigo-dark-700" />
        <circle cx="8.0002" cy="2.4001" r="0.8" fill="var(--color-indigo-300)" className="dark:fill-indigo-dark-900" />
      ...
      <defs>
        <linearGradient id={id} x1="8" y1="2.3999" x2="8" y2="20.7999" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--color-indigo-600)" className="dark:[stop-color:var(--color-indigo-dark-700)]" />
          <stop
            offset="1"
            stopColor="var(--color-indigo-500)"
            className="dark:[stop-color:var(--color-indigo-dark-800)]"
          />
        </linearGradient>
      </defs>
    </svg>
