  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn(size === 'lg' ? 'size-[180px]' : 'size-8', className)} {...rest}>
      ...
      <svg x="11.25" y="8.82" width="17.5" height="22.36" viewBox="0 0 14 18">
        ...
        />
        <path
          d="M2.3335 7H11.6668V8.55556H2.3335V7Z"
          fill="var(--color-indigo-700)"
          className="dark:fill-indigo-dark-900"
        />
        <path
          d="M2.3335 10.1113H11.6668V11.6669H2.3335V10.1113Z"
          fill="var(--color-indigo-700)"
          className="dark:fill-indigo-dark-900"
        />
        <path
          d="M2.3335 13.2222H11.6668V14.7777H2.3335V13.2222Z"
          fill="var(--color-indigo-700)"
          className="dark:fill-indigo-dark-900"
        />
        <path
