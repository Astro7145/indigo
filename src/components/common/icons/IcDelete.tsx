...
export function IcDelete({ state = 'default', className, ...rest }: IcDeleteProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className={cn(variants[state], className)} {...rest}>
      <path d="M6 6.5L18 18.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M18 6.5L6 18.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
