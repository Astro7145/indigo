...
interface IcMessageSquareProps extends SVGProps<SVGSVGElement> {
  state?: 'default' | 'active';
}

export function IcMessageSquare({ state = 'default', className, ...rest }: IcMessageSquareProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" className={cn(variants[state], className)} {...rest}>
      <path
