...
interface IcBellProps extends SVGProps<SVGSVGElement> {
  state?: 'read' | 'unread';
}

export function IcBell({ state = 'read', className, ...rest }: IcBellProps) {
  if (state === 'read') {
    return (
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className={cn('size-6', className)} {...rest}>
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx="17.5" cy="4.5" r="3.5" fill="var(--color-destructive)" />
    </svg>
  );
}
