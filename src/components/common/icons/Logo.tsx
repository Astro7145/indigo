...
export function Logo({ size = 'md', className, ...rest }: LogoProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className={cn(sizes[size], className)} {...rest}>
      <path
        opacity="0.95"
      ...
      />
      <g opacity="0.85">
        <path d="M1.84619 21.2308L12 3.69238L22.1539 21.2308H1.84619Z" fill={`url(#${g1})`} />
        <path
      ...
      <g opacity="0.85">
        <path d="M1.84619 21.2311L6.92311 12.4619L12 21.2311H1.84619Z" fill={`url(#${g2})`} />
        <path
      ...
      <defs>
        <linearGradient id={g1} x1="12" y1="3.69238" x2="12" y2="21.2308" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E7DDFF" />
          <stop offset="1" stopColor="#464590" />
        </linearGradient>
        <linearGradient id={g2} x1="6.92311" y1="12.4619" x2="6.92311" y2="21.2311" gradientUnits="userSpaceOnUse">
